...
# publishes an example message to the sns topic for raw delivery

INT_TOPIC_ARN=arn:aws:sns:eu-west-1:038610054328:IntModavSqsLambdaHelloWorld-RawTestInputTopic
